module.exports = [
	...
	{	countryCode: 'AO',		postalCodeType: 0,		pattern: 0}, // Verified
	{	countryCode: 'AI',		postalCodeType: 3,		pattern: 'AI-2640'}, // Verified
	{	countryCode: 'AG',		postalCodeType: 0,		pattern: 0}, // Verified
	...
	{	countryCode: 'AW',		postalCodeType: 0,		pattern: 0}, // Verified
	...
	{	countryCode: 'BS',		postalCodeType: 0,		pattern: 0}, // Verified
	...
	{	countryCode: 'BZ',		postalCodeType: 0,		pattern: 0}, // Verified
	{	countryCode: 'BJ',		postalCodeType: 0,		pattern: 0}, // Verified. PO Boxes have a code format 00 BP 0000 however this should be the address line.
	...
	{	countryCode: 'BO',		postalCodeType: 0,		pattern: 0}, // Verified
	{	countryCode: 'BA',		postalCodeType: 1,		pattern: /^[0-9]{5}$/, placeholder: '00000'}, // Verified
	{	countryCode: 'BW',		postalCodeType: 0,		pattern: 0}, // Verified
	{	countryCode: 'BR',		postalCodeType: 1,		pattern: /^[0-9]{5}-?[0-9]{3}$/, placeholder: '00000-000'}, // Verified
	{	countryCode: 'IO',		postalCodeType: 3,		pattern: 'BBND 1ZZ'}, // Verified
	...
	{	countryCode: 'BI',		postalCodeType: 0,		pattern: 0}, // Verified
	{	countryCode: 'KH',		postalCodeType: 1,		pattern: /^[0-9]{5}$/, placeholder: '00000'}, // Verified
	{	countryCode: 'CM',		postalCodeType: 0,		pattern: 0}, // Verified
	...
	{	countryCode: 'CF',		postalCodeType: 0,		pattern: 0}, // Verified
	{	countryCode: 'TD',		postalCodeType: 0,		pattern: 0}, // Verified
	...
	{	countryCode: 'KM',		postalCodeType: 0,		pattern: 0}, // Verified
	{	countryCode: 'CG',		postalCodeType: 0,		pattern: 0}, // Verified
	{	countryCode: 'CD',		postalCodeType: 0,		pattern: 0}, // Verified
	{	countryCode: 'CK',		postalCodeType: 0,		pattern: 0}, // Verified
	...
	{	countryCode: 'CW',		postalCodeType: 0,		pattern: 0}, // Verified
	...
	{	countryCode: 'DJ',		postalCodeType: 0,		pattern: 0}, // Verified
	{	countryCode: 'DM',		postalCodeType: 0,		pattern: 0}, // Verified
	...
	{	countryCode: 'GQ',		postalCodeType: 0,		pattern: 0}, // Verified
	{	countryCode: 'ER',		postalCodeType: 0,		pattern: 0}, // Verified
	...
	{	countryCode: 'FK',		postalCodeType: 3,		pattern: 'FIQQ 1ZZ'}, // Verified
	{	countryCode: 'FO',		postalCodeType: 1,		pattern: /^FO(-|\s)?[0-9]{3}$/, placeholder: 'FO-000'}, // Verified
	{	countryCode: 'FJ',		postalCodeType: 0,		pattern: 0}, // Verified
	...
	{	countryCode: 'GA',		postalCodeType: 0,		pattern: 0}, // Verified
	{	countryCode: 'GM',		postalCodeType: 0,		pattern: 0}, // Verified
	...
	{	countryCode: 'GI',		postalCodeType: 3,		pattern: 'GX11 1AA'}, // Verified
	...
	{	countryCode: 'GD',		postalCodeType: 0,		pattern: 0}, // Verified
	...
	{	countryCode: 'GY',		postalCodeType: 0,		pattern: 0}, // Verified
	...
	{	countryCode: 'HK',		postalCodeType: 0,		pattern: 0}, // Verified
	...
	{	countryCode: 'CI',		postalCodeType: 0,		pattern: 0}, // Verified
	{	countryCode: 'JM',		postalCodeType: 0,		pattern: 0}, // Verified. Postal code is not in effect.
	...
	{	countryCode: 'KI',		postalCodeType: 0,		pattern: 0}, // Verified
	...
	{	countryCode: 'LY',		postalCodeType: 0,		pattern: 0}, // Verified
	...
	{	countryCode: 'MO',		postalCodeType: 0,		pattern: 0}, // Verified
	{	countryCode: 'MG',		postalCodeType: 1,		pattern: /^[0-9]{3}$/, placeholder: '000'}, // Verified
	{	countryCode: 'MW',		postalCodeType: 0,		pattern: 0}, // Verified
	{	countryCode: 'MY',		postalCodeType: 1,		pattern: /^[0-9]{5}$/, placeholder: '00000'}, // Verified
	{	countryCode: 'MV',		postalCodeType: 1,		pattern: /^[0-9]{5}$/, placeholder: '00000'},
	{	countryCode: 'ML',		postalCodeType: 0,		pattern: 0},
	{	countryCode: 'MT',		postalCodeType: 1,		pattern: /^[A-Z]{3}\s?[0-9]{4}$/, placeholder: 'XXX 0000'},
	{	countryCode: 'MR',		postalCodeType: 0,		pattern: 0},
	{	countryCode: 'MU',		postalCodeType: 1,		pattern: /^[0-9]{5}$/, placeholder: '00000'},
	{	countryCode: 'MX',		postalCodeType: 1,		pattern: /^[0-9]{5}$/, placeholder: '00000'},
	...
	{	countryCode: 'MN',		postalCodeType: 1,		pattern: /^[0-9]{5}$/, placeholder: '00000'},
	{	countryCode: 'ME',		postalCodeType: 1,		pattern: /^[0-9]{5}$/, placeholder: '00000'},
	{	countryCode: 'MS',		postalCodeType: 1,		pattern: /^MSR[0-9]{4}$/, placeholder: 'MSR0000'}, // Verified
	{	countryCode: 'MA',		postalCodeType: 1,		pattern: /^[0-9]{5}$/, placeholder: '00000'},
	{	countryCode: 'MZ',		postalCodeType: 1,		pattern: /^[0-9]{4}$/, placeholder: '0000'},
	{	countryCode: 'MM',		postalCodeType: 1,		pattern: /^[0-9]{5}$/, placeholder: '00000'},
	{	countryCode: 'NA',		postalCodeType: 0,		pattern: 0},
	{	countryCode: 'NR',		postalCodeType: 0,		pattern: 0},
	{	countryCode: 'NP',		postalCodeType: 1,		pattern: /^[0-9]{5}$/, placeholder: '00000'},
	{	countryCode: 'NL',		postalCodeType: 1,		pattern: /^[0-9]{4}\s?[A-Z]{2}$/, placeholder: '0000XX'},  // Verified
	{	countryCode: 'NZ',		postalCodeType: 1,		pattern: /^[0-9]{4}$/, placeholder: '0000'},
	{	countryCode: 'NI',		postalCodeType: 1,		pattern: /^[0-9]{5}$/, placeholder: '00000'},
	{	countryCode: 'NE',		postalCodeType: 1,		pattern: /^[0-9]{4}$/, placeholder: '0000'},
	{	countryCode: 'NG',		postalCodeType: 1,		pattern: /^[0-9]{6}$/, placeholder: '000000'},
	{	countryCode: 'NU',		postalCodeType: 0,		pattern: 0},
	{	countryCode: 'MK',		postalCodeType: 1,		pattern: /^[0-9]{4}$/, placeholder: '0000'},
	{	countryCode: 'NO',		postalCodeType: 1,		pattern: /^[0-9]{4}$/, placeholder: '0000'},
	{	countryCode: 'OM',		postalCodeType: 1,		pattern: /^[0-9]{3}$/, placeholder: '000'},
	{	countryCode: 'PK',		postalCodeType: 1,		pattern: /^[0-9]{5}$/, placeholder: '00000'},
	{	countryCode: 'PS',		postalCodeType: 1,		pattern: /^[0-9]{3}$/, placeholder: '000'},
	{	countryCode: 'PA',		postalCodeType: 1,		pattern: /^[0-9]{4}$/, placeholder: '0000'},
	{	countryCode: 'PG',		postalCodeType: 1,		pattern: /^[0-9]{3}$/, placeholder: '000'},
	{	countryCode: 'PY',		postalCodeType: 1,		pattern: /^[0-9]{4}$/, placeholder: '0000'},
	{	countryCode: 'PE',		postalCodeType: 1,		pattern: /^[0-9]{5}$/, placeholder: '00000'},
	{	countryCode: 'PH',		postalCodeType: 1,		pattern: /^[0-9]{4}$/, placeholder: '0000'},
	...
	{	countryCode: 'QA',		postalCodeType: 0,		pattern: 0},  // Verified. PO Boxes are addresses. They should all be on the first line.
	...
	{	countryCode: 'RW',		postalCodeType: 0,		pattern: 0},
	...
	{	countryCode: 'ST',		postalCodeType: 0,		pattern: 0}, // Verified
	...
	{	countryCode: 'SC',		postalCodeType: 0,		pattern: 0}, //Verified
	{	countryCode: 'SL',		postalCodeType: 0,		pattern: 0}, //Verified
	{	countryCode: 'SG',		postalCodeType: 1,		pattern: /^[0-9]{6}$/, placeholder: '000000'}, // Verified
	{	countryCode: 'SX',		postalCodeType: 0,		pattern: 0}, //Verified
	...
	{	countryCode: 'SB',		postalCodeType: 0,		pattern: 0}, //Verified
	...
	{	countryCode: 'GS',		postalCodeType: 3,		pattern: 'SIQQ 1ZZ'},  //Verified
	{	countryCode: 'SS',		postalCodeType: 0,		pattern: 0}, //Verified
	...
	{	countryCode: 'SR',		postalCodeType: 0,		pattern: 0}, //Verified
	...
	{	countryCode: 'SY',		postalCodeType: 0,		pattern: 0}, //Verified
	...
	{	countryCode: 'TL',		postalCodeType: 0,		pattern: 0}, //Verified
	{	countryCode: 'TG',		postalCodeType: 0,		pattern: 0}, //Verified
	{	countryCode: 'TK',		postalCodeType: 0,		pattern: 0}, //Verified
	{	countryCode: 'TO',		postalCodeType: 0,		pattern: 0}, //Verified
	...
	{	countryCode: 'TC',		postalCodeType: 3,		pattern: 'TKCA 1ZZ'}, // Verified
	{	countryCode: 'TV',		postalCodeType: 0,		pattern: 0}, // Verified
	{	countryCode: 'UG',		postalCodeType: 0,		pattern: 0}, // Verified
	{	countryCode: 'UA',		postalCodeType: 1,		pattern: /^[0-9]{5}$/, placeholder: '00000'}, // Verified
	{	countryCode: 'AE',		postalCodeType: 0,		pattern: 0}, // Verified. PO Boxes are addresses. They should all be on the first line.
	...
	{	countryCode: 'UM',		postalCodeType: 3,		pattern: '96898'}, // Verified
	...
	{	countryCode: 'VU',		postalCodeType: 0,		pattern: 0}, // Verified
	{	countryCode: 'VA',		postalCodeType: 3,		pattern: '00120'}, // Verified
	...
	{	countryCode: 'YE',		postalCodeType: 0,		pattern: 0}, // Verified
	{	countryCode: 'ZM',		postalCodeType: 1,		pattern: /^[0-9]{5}$/, placeholder: '00000'}, // Verified
	{	countryCode: 'ZW',		postalCodeType: 0,		pattern: 0} // Verified
]